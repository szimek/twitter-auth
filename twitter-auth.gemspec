...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "Rakefile",
    "VERSION.yml",
    "app/controllers/twitter/sessions_controller.rb",
    "app/models/twitter_auth/basic_user.rb",
    "app/models/twitter_auth/generic_user.rb",
    "app/models/twitter_auth/oauth_user.rb",
    "app/views/twitter/sessions/_login_form.html.erb",
    "app/views/twitter/sessions/new.html.erb",
    "config/routes.rb",
    ...
    "generators/twitter_auth/templates/twitter_user.rb",
    ...
    "spec/controllers/twitter/sessions_controller_spec.rb",
